  ...
  return (
    <Layout>
          ...
          <div className="flex flex-col md:flex-row items-center gap-10">
            ...
            <div>
              ...
              <p className="font-body text-vb-silver/70 text-lg mt-4 max-w-xl">
                Hip-hop production built on rhythmic expression and melodious composition. Vylanous Beats crafts beats
                for independent artists who refuse to sound like everyone else — premium quality, street energy, and
                pricing that doesn't gatekeep talent.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="max-w-5xl mx-auto px-5 sm:px-8 py-16 grid md:grid-cols-3 gap-5">
        {[
          { n: "01", t: "Sound First", b: "Every beat is mixed for the speakers it'll actually play on — phones, cars, clubs, and streaming platforms." },
          { n: "02", t: "Fair Licensing", b: "Five clear tiers from free demos to full exclusive ownership. You always know exactly what you're getting." },
          { n: "03", t: "Built For Artists", b: "Affordable high-volume licensing so independent artists can release more, faster, without going broke." },
        ].map((c) => (
      ...
      <section className="max-w-5xl mx-auto px-5 sm:px-8 pb-20">
        <div className="rounded-2xl border border-vb-purple/30 bg-vb-purple/[0.06] p-8 sm:p-12 text-center glow-purple">
          ...
          <p className="font-body text-vb-silver/70 max-w-lg mx-auto mt-3">
            Custom beats, bulk deals, or just want to connect? Reach out — every serious inquiry gets a reply.
          </p>
          <a
        ...
        <div className="text-center mt-10">
          <Link to="/beats" className="inline-flex items-center gap-2 font-sub uppercase tracking-widest text-lg text-vb-purple-bright hover:underline">
