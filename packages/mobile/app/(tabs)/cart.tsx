    ...
    return (
      <ScreenCanvas>
        <View style={s.empty}>
          ...
          <ChromeText style={s.emptyTitle}>YOUR CART IS CLEAR.</ChromeText>
    ...
    <ScreenCanvas>
      <ScrollView contentContainerStyle={s.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={s.total}>
          ...
          <ChromeText style={s.totalPrice}>{formatPrice(totalCents)}</ChromeText>
        </View>
        {app.features.nativeCheckout ? (
          <>
          ...
          <View style={s.checkoutUnavailable}>
            <Text style={s.unavailableTitle}>NATIVE CHECKOUT IS CURRENTLY OFF</Text>
            <Text style={s.unavailableCopy}>
              Your selected license is saved in this cart. Please return when secure purchases are
              available again.
            </Text>
          </View>
        )}
...
const s = StyleSheet.create({
  ...
  title: { ...type.pageTitle, marginTop: 20, marginBottom: 18 },
  item: {
    flexDirection: "row",
    gap: 12,
  ...
  itemCopy: { flex: 1 },
  itemTitle: { ...type.section, fontSize: 21, lineHeight: 23 },
  ...
  totalPrice: { ...type.section, fontSize: 28, lineHeight: 30 },
  button: {
  ...
  unavailableTitle: { ...type.eyebrow, color: vb.silver },
  unavailableCopy: { ...type.body, color: vb.muted, fontSize: 13, lineHeight: 18, marginTop: 6 },
  empty: { flex: 1, paddingHorizontal: 22, paddingTop: 18, justifyContent: "center" },
  emptyTitle: { ...type.pageTitle, marginTop: 20 },
