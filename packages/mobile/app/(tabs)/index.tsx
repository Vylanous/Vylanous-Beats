...
export default function HomeScreen() {
  ...
  return <SafeAreaView style={styles.page} edges={["top"]}><ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
    <BrandHeader />
    <Text style={styles.eyebrow}>PREMIUM HIP-HOP BEATS</Text><Text style={styles.title}>Beats that{`\n`}hit different.</Text><Text style={styles.copy}>Premium hip-hop production, studio-ready licensing, and instant delivery for independent artists.</Text>
